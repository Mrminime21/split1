...
('SL001', 'Starlink Alpha', 'Starlink Standard', 'New York, USA', 'available', 15.00, 200, 20, 99.50, NOW()),
('SL002', 'Starlink Beta', 'Starlink Standard', 'Los Angeles, USA', 'available', 15.00, 200, 20, 99.20, NOW()),
('SL003', 'Starlink Gamma', 'Starlink Premium', 'London, UK', 'available', 25.00, 300, 30, 99.80, NOW()),
('SL004', 'Starlink Delta', 'Starlink Premium', 'Tokyo, Japan', 'available', 25.00, 300, 30, 99.60, NOW()),
('SL005', 'Starlink Epsilon', 'Starlink Enterprise', 'Sydney, Australia', 'available', 35.00, 500, 50, 99.90, NOW());

-- Insert system settings
INSERT INTO `system_settings` (`setting_key`, `setting_value`, `setting_type`, `category`, `description`, `is_public`) VALUES
('site_name', 'Starlink Rent', 'string', 'general', 'Website name', 1),
('site_url', 'http://localhost', 'string', 'general', 'Website URL', 1),
...
('plisio_api_key', '', 'string', 'payments', 'Plisio.net API key', 0),
...
('welcome_email_enabled', '1', 'boolean', 'email', 'Send welcome emails', 0),
('deposit_email_enabled', '1', 'boolean', 'email', 'Send deposit confirmation emails', 0),
('withdrawal_email_enabled', '1', 'boolean', 'email', 'Send withdrawal notification emails', 0),
('daily_earnings_email_enabled', '0', 'boolean', 'email', 'Send daily earnings emails', 0),
('referral_email_enabled', '1', 'boolean', 'email', 'Send referral bonus emails', 0);
...
-- --------------------------------------------------------
-- Create functions for referral code generation
-- --------------------------------------------------------
...
CREATE PROCEDURE `create_referral_relationships`(IN user_id INT, IN referred_by INT)
BEGIN
    DECLARE level2_referrer INT DEFAULT NULL;
    DECLARE level3_referrer INT DEFAULT NULL;
